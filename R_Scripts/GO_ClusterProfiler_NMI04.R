...
df <- read.delim("GeneListOnly_CpGOfNMI0.04.txt", header = F) #Gene List in text file
...
myEnrichKegg <- enrichKEGG(GeneID$ENTREZID, organism = "hsa", keyType = "ncbi-geneid",pvalueCutoff = 0.1) #KEGG Pathway
