...
Feat_Data = vroom("CognitionCateg_Methylome_APPRDXFilter.csv")
...
colnames(test_result) <- ("MutInf_Cognition")
test_result$Normalized <- (test_result$MutInf_Cognition)/(0.6025032053)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_APPRDX_Cognition.csv")
...
colnames(test_result) <- ("MutInf_Cognition")
test_result$Normalized <- (test_result$MutInf_Cognition)/(0.454641424)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_CategWise_Cognition.csv")
...
colnames(test_result) <- ("MutInf_Cognition")
test_result$Normalized <- (test_result$MutInf_Cognition)/(0.6324018757)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_Gender_Cognition.csv")
...
colnames(test_result) <- ("MutInf_Cognition")
test_result$Normalized <- (test_result$MutInf_Cognition)/(1.159476211)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_HYS_Cognition.csv")
...
colnames(test_result) <- ("MutInf_Cognition")
test_result$Normalized <- (test_result$MutInf_Cognition)/(0.4522234422)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinPatient_CategWise_Cognition.csv")
...
colnames(test_result) <- ("MutInf_Cognition")
test_result$Normalized <- (test_result$MutInf_Cognition)/(0.367523790)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinHealthy_CategWise_Cognition.csv")
