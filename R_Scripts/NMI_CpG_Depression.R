...
Feat_Data = vroom("DepressionCateg_Methylome_APPRDXFilter.csv")
...
colnames(test_result) <- ("MutInf_Depression")
test_result$Normalized <- (test_result$MutInf_Depression)/(0.6025032053)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_APPRDX_Depression.csv")
...
colnames(test_result) <- ("MutInf_Depression")
test_result$Normalized <- (test_result$MutInf_Depression)/(0.575648852)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_CategWise_Depression.csv")
...
colnames(test_result) <- ("MutInf_Depression")
test_result$Normalized <- (test_result$MutInf_Depression)/(0.6324018757)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_Gender_Depression.csv")
...
colnames(test_result) <- ("MutInf_Depression")
test_result$Normalized <- (test_result$MutInf_Depression)/(1.159476211)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_HYS_Depression.csv")
...
colnames(test_result) <- ("MutInf_Depression")
test_result$Normalized <- (test_result$MutInf_Depression)/(0.570259420)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinPatient_CategWise_Depression.csv")
...
colnames(test_result) <- ("MutInf_Depression")
test_result$Normalized <- (test_result$MutInf_Depression)/(0.58523052)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinHealthy_CategWise_Depression.csv")
