...
Feat_Data = vroom("SleepDayCateg_Methylome_APPRDXFilter.csv")
...
colnames(test_result) <- ("MutInf_SleepDay")
test_result$Normalized <- (test_result$MutInf_SleepDay)/(0.6025032053)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_APPRDX_SleepDay.csv")
...
colnames(test_result) <- ("MutInf_SleepDay")
test_result$Normalized <- (test_result$MutInf_SleepDay)/(0.737104699)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_CategWise_SleepDay.csv")
...
colnames(test_result) <- ("MutInf_SleepDay")
test_result$Normalized <- (test_result$MutInf_SleepDay)/(0.632401876)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_Gender_SleepDay.csv")
...
colnames(test_result) <- ("MutInf_SleepDay")
test_result$Normalized <- (test_result$MutInf_SleepDay)/(1.159476211)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_HYS_SleepDay.csv")
...
colnames(test_result) <- ("MutInf_SleepDay")
test_result$Normalized <- (test_result$MutInf_SleepDay)/(0.738119742)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinPatient_CategWise_SleepDay.csv")
...
colnames(test_result) <- ("MutInf_SleepDay")
test_result$Normalized <- (test_result$MutInf_SleepDay)/(0.72660290)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinHealthy_CategWise_SleepDay.csv")
