...
Feat_Data = vroom("FatigueCateg_Methylome_APPRDXFilter.csv")
...
colnames(test_result) <- ("MutInf_Fatigue")
test_result$Normalized <- (test_result$MutInf_Fatigue)/(0.6025032053)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_APPRDX_Fatigue.csv")
...
colnames(test_result) <- ("MutInf_Fatigue")
test_result$Normalized <- (test_result$MutInf_Fatigue)/(0.82400955)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_CategWise_Fatigue.csv")
...
colnames(test_result) <- ("MutInf_Fatigue")
test_result$Normalized <- (test_result$MutInf_Fatigue)/(0.6324019)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_Gender_Fatigue.csv")
...
colnames(test_result) <- ("MutInf_Fatigue")
test_result$Normalized <- (test_result$MutInf_Fatigue)/(1.159476211)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_HYS_Fatigue.csv")
...
colnames(test_result) <- ("MutInf_Fatigue")
test_result$Normalized <- (test_result$MutInf_Fatigue)/(0.849183671)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinPatient_CategWise_Fatigue.csv")
...
colnames(test_result) <- ("MutInf_Fatigue")
test_result$Normalized <- (test_result$MutInf_Fatigue)/(0.73642783)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinHealthy_CategWise_Fatigue.csv")
