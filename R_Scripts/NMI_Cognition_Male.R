...
Feat_Data = vroom("CognitionCateg_Methylome_Male.csv")
...
test_result$Normalized <- (test_result$MutInf_UPSIT)/(0.616017321)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_APPRDX_Cognition_Male.csv")
...
colnames(test_result) <- ("MutInf_UPSIT")
test_result$Normalized <- (test_result$MutInf_UPSIT)/(0.4050817274)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_CategWise_Cognition_Male.csv")
...
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_HYS_Cognition_Male.csv")
...
colnames(test_result) <- ("MutInf_UPSIT")
test_result$Normalized <- (test_result$MutInf_UPSIT)/(0.4243420197)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinPatient_CategWise_Cognition_Male.csv")
...
colnames(test_result) <- ("MutInf_UPSIT")
test_result$Normalized <- (test_result$MutInf_UPSIT)/(0.360947778)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinHealthy_CategWise_Cognition_Male.csv")
