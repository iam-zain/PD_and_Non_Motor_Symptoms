...
Feat_Data = vroom("SymbDigiCateg_Methylome_APPRDXFilter.csv")
...
colnames(test_result) <- ("MutInf_SymbDigi")
test_result$Normalized <- (test_result$MutInf_SymbDigi)/(0.6025032053)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_APPRDX_SymbDigi.csv")
...
colnames(test_result) <- ("MutInf_SymbDigi")
test_result$Normalized <- (test_result$MutInf_SymbDigi)/(1.038954797)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_CategWise_SymbDigi.csv")
...
colnames(test_result) <- ("MutInf_SymbDigi")
test_result$Normalized <- (test_result$MutInf_SymbDigi)/(0.6324018757)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_Gender_SymbDigi.csv")
...
colnames(test_result) <- ("MutInf_SymbDigi")
test_result$Normalized <- (test_result$MutInf_SymbDigi)/(1.159476211)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_HYS_SymbDigi.csv")
...
colnames(test_result) <- ("MutInf_SymbDigi")
test_result$Normalized <- (test_result$MutInf_SymbDigi)/(1.037969201)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinPatient_CategWise_SymbDigi.csv")
...
colnames(test_result) <- ("MutInf_SymbDigi")
test_result$Normalized <- (test_result$MutInf_SymbDigi)/(0.6657319437)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinHealthy_CategWise_SymbDigi.csv")
