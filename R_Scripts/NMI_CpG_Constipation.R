...
Feat_Data = vroom("ConstipationCateg_Methylome_APPRDXFilter.csv")
...
colnames(test_result) <- ("MutInf_Constipation")
test_result$Normalized <- (test_result$MutInf_Constipation)/(0.6025032053)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_APPRDX_Constipation.csv")
...
colnames(test_result) <- ("MutInf_Constipation")
test_result$Normalized <- (test_result$MutInf_Constipation)/(0.627160248)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_CategWise_Constipation.csv")
...
colnames(test_result) <- ("MutInf_Constipation")
test_result$Normalized <- (test_result$MutInf_Constipation)/(0.6324018757)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_Gender_Constipation.csv")
...
colnames(test_result) <- ("MutInf_Constipation")
test_result$Normalized <- (test_result$MutInf_Constipation)/(1.159476211)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_HYS_Constipation.csv")
...
colnames(test_result) <- ("MutInf_Constipation")
test_result$Normalized <- (test_result$MutInf_Constipation)/(0.654530812)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinPatient_CategWise_Constipation.csv")
...
colnames(test_result) <- ("MutInf_Constipation")
test_result$Normalized <- (test_result$MutInf_Constipation)/(0.5517722779)
test_result <- arrange(test_result, desc(Normalized))
write.csv(test_result, "NMI_WithinHealthy_CategWise_Constipation.csv")
